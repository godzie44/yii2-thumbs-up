...
namespace app\modules\yiithumbsup\forms;
...
class ThumbsUpForm extends \yii\base\Model
{
    ...
    public $upValue;
    public $downValue;
    /** @var yiithumbsup\models\Thumbsup */
    public $thumbsUp;
    ...
    {
        /**
         * @var $thumbsUpModel yiithumbsup\models\ThumbsUp
         */
    ...
    {
        /**@var $thumbsUp yiithumbsup\models\ThumbsUp */
